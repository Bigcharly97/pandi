...
mobile: MethodMobile, 
browser: opcion == '1' ? ['PandiBot', 'Edge', '2.0.0'] : methodCodeQR ? ['PandiBot', 'Edge', '2.0.0'] : ['Chrome (Linux)', '', ''],
auth: {
creds: state.creds,
...
console.log(chalk.bgBlack(chalk.bold.greenBright('Escriba su bien su numero, ejemplo "59 3960 070183"')))
process.exit(0)
}} else {
while (true) {
addNumber = await question(chalk.bold.greenBright(`EL NUMERO ESTABLECIDO SE ENCUENTRA ERRONEO, SIGA ESTE EJEMPLO. EJEMPLO: "59 3960 070183"`))
